...
def verify_message_integrity(encrypted, decrypted):
    import hashlib
    # Create hash of decrypted message
    msg_hash = hashlib.sha256(decrypted.encode()).hexdigest()
    return msg_hash[:16]  # Return first 16 chars as integrity token
